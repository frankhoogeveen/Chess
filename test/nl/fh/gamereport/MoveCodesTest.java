...
public class MoveCodesTest {
    ...
    public void testEnPassantCapture2(){
        ...
        assertEquals("fxe6#", m.moveString(state, rules));             
    }    
    ...
    public void testPieceMove5(){
        ...
        assertEquals("Rce6", m.moveString(state, rules)); 
    }   
    ...
    public void testPieceMove6(){
        ...
        assertEquals("R4e6", m.moveString(state, rules)); 
    }  
    ...
    public void testPieceMove7(){
        ...
        assertEquals("Rae4+", m.moveString(state, rules)); 
    }    
    ...
    public void testPieceMove8(){
        ...
        assertEquals("Q6e6#", m.moveString(state, rules)); 
    }    
    ...
    public void testPromotion(){
        ...
        assertEquals("e8=N", m.moveString(state, rules));         
    }    
