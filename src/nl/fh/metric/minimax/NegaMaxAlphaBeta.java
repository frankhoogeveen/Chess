 ...
 * 
 */
public class NegaMaxAlphaBeta<T extends ChessState> implements Metric<T> {
    ...
    private double iteration(ChessState state, int depth, int sign, double alpha, double beta) {
        if(depth == 0){
